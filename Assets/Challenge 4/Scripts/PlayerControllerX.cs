...
public class PlayerControllerX : MonoBehaviour
{
    ...
    public ParticleSystem landingEffect; // Optional particle effect for landing
    ...
    // Ground check with visualization
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        else if (other.gameObject.CompareTag("Jump Powerup")){
            Destroy(other.gameObject);
            hasJumpPowerup = true;
